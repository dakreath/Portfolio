function FloatingCTA() {
  return (
    <>
    <a className="floating-cta" href="mailto:dak.reath@mail.mcgill.ca" aria-label="Let's talk">
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-chat-quote-fill" viewBox="0 0 16 16">
